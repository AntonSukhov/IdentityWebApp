...
namespace IdentityWebApp.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        /// </summary>
        [BindProperty]
        public Models.UserIndexModel Input { get; set; }
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            Input = new Models.UserIndexModel
            {
                Username = userName,
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Не удается загрузить пользователя c идентификатором '{_userManager.GetUserId(User)}'.");
            }
